...
urlpatterns = [
    ...
    path('<int:pk>/<int:Y>/<int:m>/<int:d>/create/single/', service_views.CreateSingleServiceNote.as_view(), name='create_single_note'),
    path('<int:pk>/<int:Y>/<int:m>/<int:d>/create/multi/', service_views.CreateMultiServiceNote.as_view(), name='create_multi_note'),
